...
//    myWorld.saveCyclePlot(resultCycle_steepest, "./test_steepest1.png");

    vector<int>resultCycle_sim = anAgent.simulatedAnnealing(30);
    myWorld.saveCyclePlot(resultCycle_sim, "./test_sim30.png");
    //TODO
